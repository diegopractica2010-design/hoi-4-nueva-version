...
> **Generated Content** — This catalog is auto-generated by the scripts in `tools/`.  
> Do **not** edit individual `.json` files manually if they were generated.  
> To regenerate everything, run:  
> `./tools/regenerate_catalogs.sh`

## Generation Commands (as of May 2026)

All modules and unit templates across WW1 → 2030s + Space + Naval were created using the following generators:

- `generate_interwar_gap_modules.py`
- `generate_unit_templates.py`
- `generate_specialized_equipment_modules.py`
- `generate_late_ww2_cold_war_modules.py` / `_unit_templates.py`
- `generate_sixties_seventies_modules.py` / `_unit_templates.py`
- `generate_eighties_nineties_modules.py` / `_unit_templates.py`
- `generate_2000s_2010s_modules.py` / `_unit_templates.py`
- `generate_2020s_2030s_modules.py` / `_unit_templates.py`
- `generate_space_modules.py` + `generate_space_unit_templates.py`
- `generate_1936_naval_fleet.py`, `generate_surface_naval_fleet.py`, etc.
- `generate_missile_launcher_systems.py`, `generate_transport_cargo_naval.py`, `generate_scenario_frigates.py`

**Current totals:** 1031 modules • 667 templates • 31 nations covered in 1918 & 1936 scenarios.

For full regeneration instructions see `tools/regenerate_catalogs.sh`.
